...
func _ready() -> void:
	...
	_kit.tile_highway(_segments, _gaps, true, 0.38, true)
	_kit.build_gap_dressing(_gaps, true)
	_kit.build_edge_rails(_segments)
	_kit.build_street_lights(-80.0, 80.0, 20.0)
	_kit.build_roadside_props(-80.0, 80.0, true)
