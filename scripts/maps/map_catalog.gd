...
const ENTRIES: Array[Dictionary] = [
	...
	{
		"id": "ai_generated_phase3_moving_hazard_probe",
		"display_name": "AI Phase 3 Moving Hazard PROBE",
		"resource_path": "res://resources/maps/ai_generated_phase3_moving_hazard_probe.tres",
		"scene_path": "res://scenes/maps/ai_generated_phase3_moving_hazard_probe.tscn",
		"enabled": false,
		"status": STATUS_PROTOTYPE,
		"legacy_index": 11,
		"ai_generated": true,
		"ai_blueprint_id": "phase3_moving_hazard_probe",
	},
	{
		"id": "ai_generated_multi_layer_fallthrough_probe",
		"display_name": "AI Multi-Layer Fallthrough PROBE",
		"resource_path": "res://resources/maps/ai_generated_multi_layer_fallthrough_probe.tres",
		"scene_path": "res://scenes/maps/ai_generated_multi_layer_fallthrough_probe.tscn",
		"enabled": false,
		"status": STATUS_PROTOTYPE,
		"legacy_index": 12,
		"ai_generated": true,
		"ai_blueprint_id": "multi_layer_fallthrough_probe",
	},
]
