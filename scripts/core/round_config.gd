...
## Legacy headless/tests: when require_manual_launch is false and this is 0, staged races auto-launch.
@export_range(0, 15, 1) var countdown_seconds: int = 0
@export var require_manual_launch: bool = true
