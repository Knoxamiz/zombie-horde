...
signal join_rejected(display_name: String, reason: String)
signal join_accepted_late(display_name: String)
signal post_round_auto_reset_tick(seconds_remaining: int)
